...
enum opt_code
{
  ...
  OPT_mharden_sls_ = 1712,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1713,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1714,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1715,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1716,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1717,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1718,               /* -moutline-atomics */
  OPT_moverride_ = 1719,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1720,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1721,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1722, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1723,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1724,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1725,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1726,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1727,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1728,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1729,             /* -mtrack-speculation */
  OPT_mtune_ = 1730,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1731,             /* -mverbose-cost-dump */
  OPT_n = 1732,                              /* -n */
  OPT_name_sort = 1733,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1734,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1735,              /* -no-integrated-cpp */
  OPT_no_pie = 1736,                         /* -no-pie */
  OPT_nocpp = 1737,                          /* -nocpp */
  OPT_nodefaultlibs = 1738,                  /* -nodefaultlibs */
  OPT_nolibc = 1739,                         /* -nolibc */
  OPT_nophoboslib = 1740,                    /* -nophoboslib */
  OPT_nostartfiles = 1741,                   /* -nostartfiles */
  OPT_nostdinc = 1742,                       /* -nostdinc */
  OPT_nostdinc__ = 1743,                     /* -nostdinc++ */
  OPT_nostdlib = 1744,                       /* -nostdlib */
  OPT_o = 1745,                              /* -o */
  OPT_objects = 1746,                        /* -objects */
  OPT_p = 1747,                              /* -p */
  OPT_pass_exit_codes = 1748,                /* -pass-exit-codes */
  /* OPT_pedantic = 1749, */                 /* -pedantic */
  OPT_pedantic_errors = 1750,                /* -pedantic-errors */
  OPT_pg = 1751,                             /* -pg */
  OPT_pie = 1752,                            /* -pie */
  OPT_pipe = 1753,                           /* -pipe */
  ...
  OPT_print_value = 1765,                    /* -print-value */
  OPT_quiet = 1766,                          /* -quiet */
  OPT_r = 1767,                              /* -r */
  OPT_remap = 1768,                          /* -remap */
  OPT_reverse_sort = 1769,                   /* -reverse-sort */
  OPT_s = 1770,                              /* -s */
  OPT_save_temps = 1771,                     /* -save-temps */
  OPT_save_temps_ = 1772,                    /* -save-temps= */
  OPT_shared = 1773,                         /* -shared */
  OPT_shared_libgcc = 1774,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1775,               /* -shared-libphobos */
  OPT_size_sort = 1776,                      /* -size-sort */
  /* OPT_specs = 1777, */                    /* -specs */
  OPT_specs_ = 1778,                         /* -specs= */
  OPT_static = 1779,                         /* -static */
  OPT_static_libasan = 1780,                 /* -static-libasan */
  OPT_static_libgcc = 1781,                  /* -static-libgcc */
  OPT_static_libgfortran = 1782,             /* -static-libgfortran */
  OPT_static_libgo = 1783,                   /* -static-libgo */
  OPT_static_libhwasan = 1784,               /* -static-libhwasan */
  OPT_static_liblsan = 1785,                 /* -static-liblsan */
  OPT_static_libmpx = 1786,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1787,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1788,               /* -static-libphobos */
  OPT_static_libstdc__ = 1789,               /* -static-libstdc++ */
  OPT_static_libtsan = 1790,                 /* -static-libtsan */
  OPT_static_libubsan = 1791,                /* -static-libubsan */
  OPT_static_pie = 1792,                     /* -static-pie */
  /* OPT_std_c__03 = 1793, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1794, */                /* -std=c++0x */
  OPT_std_c__11 = 1795,                      /* -std=c++11 */
  OPT_std_c__14 = 1796,                      /* -std=c++14 */
  OPT_std_c__17 = 1797,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1798, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1799, */                /* -std=c++1z */
  OPT_std_c__20 = 1800,                      /* -std=c++20 */
  OPT_std_c__23 = 1801,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1802, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1803, */                /* -std=c++2b */
  OPT_std_c__98 = 1804,                      /* -std=c++98 */
  OPT_std_c11 = 1805,                        /* -std=c11 */
  OPT_std_c17 = 1806,                        /* -std=c17 */
  /* OPT_std_c18 = 1807, */                  /* -std=c18 */
  /* OPT_std_c1x = 1808, */                  /* -std=c1x */
  OPT_std_c2x = 1809,                        /* -std=c2x */
  /* OPT_std_c89 = 1810, */                  /* -std=c89 */
  OPT_std_c90 = 1811,                        /* -std=c90 */
  OPT_std_c99 = 1812,                        /* -std=c99 */
  /* OPT_std_c9x = 1813, */                  /* -std=c9x */
  OPT_std_f2003 = 1814,                      /* -std=f2003 */
  OPT_std_f2008 = 1815,                      /* -std=f2008 */
  OPT_std_f2008ts = 1816,                    /* -std=f2008ts */
  OPT_std_f2018 = 1817,                      /* -std=f2018 */
  OPT_std_f95 = 1818,                        /* -std=f95 */
  OPT_std_gnu = 1819,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1820, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1821, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1822,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1823,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1824,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1825, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1826, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1827,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1828,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1829, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1830, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1831,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1832,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1833,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1834, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1835, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1836,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1837, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1838,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1839,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1840, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1841, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1842,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1843, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1844, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1845, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1846, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1847, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1848,                     /* -std=legacy */
  OPT_stdlib_ = 1849,                        /* -stdlib= */
  OPT_symbol_ = 1850,                        /* -symbol= */
  OPT_symbolic = 1851,                       /* -symbolic */
  OPT_t = 1852,                              /* -t */
  OPT_time = 1853,                           /* -time */
  OPT_time_ = 1854,                          /* -time= */
  OPT_traditional = 1855,                    /* -traditional */
  OPT_traditional_cpp = 1856,                /* -traditional-cpp */
  OPT_tree_stats = 1857,                     /* -tree-stats */
  OPT_trigraphs = 1858,                      /* -trigraphs */
  OPT_type_stats = 1859,                     /* -type-stats */
  OPT_u = 1860,                              /* -u */
  OPT_undef = 1861,                          /* -undef */
  OPT_v = 1862,                              /* -v */
  OPT_version = 1863,                        /* -version */
  OPT_w = 1864,                              /* -w */
  OPT_wrapper = 1865,                        /* -wrapper */
  OPT_x = 1866,                              /* -x */
  OPT_z = 1867,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
